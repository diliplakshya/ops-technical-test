...
from technicaltest.application_response import ApplicationResponse


class ApplicationResponseViews(object):
    """Custom ApplicationResponseViews"""

    def __init__(self):
        super(ApplicationResponseViews, self).__init__()
